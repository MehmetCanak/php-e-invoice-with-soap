...
class QueryInboxDocumentsWithReceivedDateWithSearchParams
{
   ...
   * @access public
   */
  public function __construct($startDate, $endDate, $documentType, $queried, $withXML, $takenFromEntegrator, $minRecordId, $searchParams)
  {
